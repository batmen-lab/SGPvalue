...
# python blastp_wrapper.py --num_shuffle 50 --lookup_url data/rankprop6/psiblast/pvs_f0_t34_b0.001_N1e10_m50_ls33_ss15_l0_s3.txt --blastp_url /media/yanglu/Data/proj/ncbi-blast-2.14.0+-src/c++/ReleaseMT/bin/./blastp blastp -gapopen 9 -gapextend 2 -num_alignments 0 -num_descriptions 100 -evalue 10000 -matrix BLOSUM62 -db $db_dir /media/yanglu/Data/proj/2019_ylu465_siglinkpred/data/rankprop6/sanity_check/db_scop_origin/scop_db -query /media/yanglu/Data/proj/2019_ylu465_siglinkpred/data/rankprop6/sanity_check/tmp.fasta -out /media/yanglu/Data/proj/2019_ylu465_siglinkpred/data/rankprop6/sanity_check/tmp.BL62.blastp
# python blastp_wrapper.py --num_shuffle 50 --lookup_url /net/noble/vol2/user/ylu465/2019_ylu465_siglinkpred/data/rankprop6/psiblast/pvs_f0_t34_b0.001_N1e10_m50_ls33_ss15_l0_s3.txt --blastp_url blastp blastp -gapopen 9 -gapextend 2 -num_alignments 0 -num_descriptions 100 -evalue 10000 -matrix BLOSUM62 -db $db_dir /net/noble/vol2/user/ylu465/2019_ylu465_siglinkpred/data/rankprop6/psiblast/demo/db_scop_origin/scop_db -query /net/noble/vol2/user/ylu465/2019_ylu465_siglinkpred/data/rankprop6/psiblast/demo/example.fasta -out /net/noble/vol2/user/ylu465/2019_ylu465_siglinkpred/data/rankprop6/psiblast/demo/example.BL62.blastp